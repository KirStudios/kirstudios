try:
    ...
    file_warn = True
    ver = "PY-DOS 0.990"
    pydos_application_developer_documentation = "Hello! Welcome to the PY-DOS Application Developer Documentation for versions 0.97 and higher!\n\nAPI Calls:\n'ramdrivemgr()' a function that allows you to rename, edit, delete, create, or view files in the RAMdrive. To type a command, type 'type=[the command you want to type]'. This function can only be used when Extra Protect is FALSE.\n'confirm()' allows you to prompt the user."
    ramdrive = {}
